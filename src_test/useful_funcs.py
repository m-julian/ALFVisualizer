...
def change_actor_color(plotter, actor, color=None, style=None, scalars=None,
    ...
    **kwargs : dict, optional
    ...
    if show_edges is None:
        show_edges = plotter._theme.show_edges

    if edge_color is None:
        edge_color = plotter._theme.edge_color

    if show_scalar_bar is None:
        show_scalar_bar = plotter._theme.show_scalar_bar

    if lighting is None:
        lighting = plotter._theme.lighting
    ...
    if not render_points_as_spheres:
        render_points_as_spheres = plotter._theme.render_points_as_spheres

    if not nan_color:
        nan_color = plotter._theme.nan_color
    nan_color = list(parse_color(nan_color))
    nan_color.append(nan_opacity)

    if color:
        color = plotter._theme.color
    ...
    if style == 'wireframe':
        ...
        if color is None:
            color = plotter._theme.outline_color
    elif style == 'points':
    ...
    rgb_color = parse_color(color, default_color=plotter._theme.color)
